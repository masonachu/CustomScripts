...
public class PlayerAttack : MonoBehaviour
{
    ...
    [Header("FMOD")]
    public string LightningAtkSFX = "event:/SFXs/Weapons/wpn_elec/wpn_elec_attack";
    public string GasAtkSFX = "event:/SFXs/Weapons/wpn_gas/wpn_gas_attack";
    public string GooAtkSFX = "event:/SFXs/Weapons/wpn_goo/wpn_goo_attack";
    public string IceAtkSFX = "event:/SFXs/Weapons/wpn_ice/wpn_ice_attack";

    private string ElecEquip = "event:/SFXs/Weapons/wpn_elec/wpn_elec_equip";
    private string GasEquip = "event:/SFXs/Weapons/wpn_gas/wpn_gas_equip";
    private string GooEquip = "event:/SFXs/Weapons/wpn_goo/wpn_goo_equip";
    private string IceEquip = "event:/SFXs/Weapons/wpn_ice/wpn_ice_equip";

    FMOD.Studio.EventInstance IceLoop;
    ...
    public void SwitchAttack()
	{
		...
		switch (attackIndex)
		{
			...
			case 0:
                ...
                FMODUnity.RuntimeManager.PlayOneShot(ElecEquip, transform.position);
				break;
			...
			case 1:
                ...
                FMODUnity.RuntimeManager.PlayOneShot(IceEquip, transform.position);
                break;
			...
			case 2:
                ...
                FMODUnity.RuntimeManager.PlayOneShot(GasEquip, transform.position);
                break;
			...
			case 3:
                ...
                FMODUnity.RuntimeManager.PlayOneShot(GooEquip, transform.position);
                break;
		}
	}
	...
	void ToggleFrost(bool isAttacking)
	{
        ...
        //Trigger Audio
        //IceLoop = FMODUnity.RuntimeManager.CreateInstance(IceAtkSFX);
        //IceLoop.start();
        //IceLoop.setParameterByName("isFiring", 1);
	...
	void ShootStink()
	{
        ...
        //Trigger Audio
        FMODUnity.RuntimeManager.PlayOneShot(GasAtkSFX, transform.position);
	...
	void ShootSlime()
	{
        ...
        {
            //Trigger Audio
            FMODUnity.RuntimeManager.PlayOneShot(GooAtkSFX, transform.position);
